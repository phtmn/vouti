            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <form action="{{route('cabo_eleitoral.update', [ 'id' => $caboeleitoral->id ])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-10">
                            <input type="text" name="name" value="{{ $caboeleitoral->user->name }}" placeholder="Nome Completo" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nome Completo'" required class="single-input" >
                        </div>
                        <div class="mt-10">
                        ...
                        <label> Acesso ao Sistema </label>
                            <input type="text" name="email" value="{{$caboeleitoral->user->email}}" placeholder="E-mail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'E-mail'" required class="single-input" >
                        </div>
                        {{-- <div class="mt-10">
